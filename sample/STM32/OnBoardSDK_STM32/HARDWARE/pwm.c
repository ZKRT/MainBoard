/**
  ...
  *          + (3) 删除PB0,PB1, sbus的pwm从PB3变为PA0, PWM1_T13_CH1_PF8,
	             PWM4_T14_CH1_PF9保持不变，即只有两路PWM和一路SBUS PWM
	*         
  ******************************************************************************
  * @attention
  *
...
{		 					 
	...
	//时钟使能
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_TIM13|RCC_APB1Periph_TIM14 ,ENABLE); 
